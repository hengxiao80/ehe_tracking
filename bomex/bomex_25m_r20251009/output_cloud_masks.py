...
# print(len(uninterrupted_large_clouds_list))

with open('pkl/attached_clouds.pkl', 'rb') as f:
    attached_clouds = pickle.load(f)
ula_clouds = [f'{i}' for i in attached_clouds] 
